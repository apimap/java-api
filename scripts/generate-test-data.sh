...
curl --header "Content-Type: application/json" \
	...
	"http://localhost:8080/taxonomy" 2> /dev/null | jq
...
### 01.06.2022
- Something new'\
  "http://localhost:8080/api/Test3/version/1/changelog" 2> /dev/null
...
-- Hello World --'\
  "http://localhost:8080/api/Test3/version/1/readme" 2> /dev/null

curl --header "Content-Type: application/json" \
  --header "Authorization: Bearer ${token}" \
  --request POST\
  --data '{"data": {"attributes": {"rating": 5}}}' \
  "http://localhost:8080/api/Test3/version/1/vote" 2> /dev/null | jq
...
### 01.06.2022
- Something new'\
  "http://localhost:8080/api/Test4/version/1/changelog" 2> /dev/null
...
'\
  "http://localhost:8080/api/Test4/version/1/readme" 2> /dev/null

curl --header "Content-Type: application/json" \
  --header "Authorization: Bearer ${token}" \
  --request POST\
  --data '{"data": {"attributes": {"rating": 2}}}' \
  "http://localhost:8080/api/Test4/version/1/vote" 2> /dev/null | jq
...
### 01.06.2022
- Something new'\
  "http://localhost:8080/api/Test5/version/1/changelog" 2> /dev/null
...
-- Hello World --'\
  "http://localhost:8080/api/Test5/version/1/readme" 2> /dev/null

curl --header "Content-Type: application/json" \
  --header "Authorization: Bearer ${token}" \
  --request POST\
  --data '{"data": {"attributes": {"rating": 1}}}' \
  "http://localhost:8080/api/Test5/version/1/vote" 2> /dev/null | jq
...
curl --header "Content-Type: application/json" \
  --header "Authorization: Bearer ${token}" \
	--request POST\
	--data '{"data":{"attributes":{"version": "1"}}}' \
	"http://localhost:8080/api/Test6/version" 2> /dev/null | jq
...
curl --header "Content-Type: application/json" \
  --header "Authorization: Bearer ${token}" \
	...
	"http://localhost:8080/api/Test6/version/1/metadata" 2> /dev/null | jq
...
curl --header "Content-Type: application/json" \
  ...
  --data '{"data":[{"attributes": {"urn": "urn:apimap:8", "taxonomyVersion": "1"}}]}' \
	"http://localhost:8080/api/Test6/version/1/classification" 2> /dev/null | jq
...
### 01.06.2022
- Something new'\
  "http://localhost:8080/api/Test6/version/1/changelog" 2> /dev/null
...
-- Hello World --'\
  "http://localhost:8080/api/Test6/version/1/readme" 2> /dev/null

curl --header "Content-Type: application/json" \
  --header "Authorization: Bearer ${token}" \
  --request POST\
  --data '{"data": {"attributes": {"rating": 5}}}' \
  "http://localhost:8080/api/Test6/version/1/vote" 2> /dev/null | jq