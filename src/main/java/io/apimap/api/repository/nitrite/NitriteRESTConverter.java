...
import io.apimap.api.repository.nitrite.entities.*;
...
public class NitriteRESTConverter implements IRESTConverter {
    /*
     From REST
     */
    ...
    public Mono<ITaxonomyCollectionVersionURN> decodeTaxonomyCollectionVersionURN(TaxonomyContext taxonomyContext, JsonApiRestRequestWrapper<TaxonomyDataRestEntity> object) {
        return Mono.justOrEmpty(
            new TaxonomyCollectionVersionURN(
    ...
    public Mono<JsonApiRestResponseWrapper<TaxonomyCollectionDataRestEntity>> encodeTaxonomyCollection(URI uri, ITaxonomyCollection collection) {
        JsonApiRelationships relationships = new JsonApiRelationships();
        relationships.addRelationshipRef(JsonApiRestResponseWrapper.VERSION_COLLECTION, URIUtil.rootLevelFromURI(uri)
                .append("taxonomy")
                .append(collection.getNid())
                .append("version")
                .uriValue());
    ...
    @Override
    public Mono<JsonApiRestResponseWrapper<TaxonomyVersionCollectionRootRestEntity>> encodeTaxonomyCollectionVersions(URI uri, List<ITaxonomyCollectionVersion> versions) {
        ArrayList<TaxonomyVersionCollectionDataRestEntity> content = versions
                .stream()
